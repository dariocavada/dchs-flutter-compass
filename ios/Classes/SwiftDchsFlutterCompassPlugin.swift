...
public class SwiftDchsFlutterCompassPlugin: NSObject, FlutterPlugin, FlutterStreamHandler, CLLocationManagerDelegate {
  ...
  public static func register(with registrar: FlutterPluginRegistrar) {
    let channel = FlutterEventChannel.init(name: "dariocavada/dchs_flutter_compass", binaryMessenger: registrar.messenger())
    _ = SwiftDchsFlutterCompassPlugin(channel: channel);
  }
