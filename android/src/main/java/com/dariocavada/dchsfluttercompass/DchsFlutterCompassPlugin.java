package com.dariocavada.dchsfluttercompass;
...
public final class DchsFlutterCompassPlugin implements FlutterPlugin, StreamHandler {
    private static final String TAG = "DchsFlutterCompass";
    ...
    public DchsFlutterCompassPlugin() {
        // no-op
    }
    ...
    public void onAttachedToEngine(@NonNull FlutterPluginBinding binding) {
        channel = new EventChannel(binding.getBinaryMessenger(), "dariocavada/dchs_flutter_compass");
